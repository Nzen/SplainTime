...
public class StConfigurationRecord extends UpdatableRecordImpl<StConfigurationRecord> implements Record7<Integer, String, Integer, Integer, String, Integer, Boolean> {

    private static final long serialVersionUID = 836820301;
